const workExperience = {
  ...
  'Holiday Extras': {
    ...
    desc: [
      'Worked in an Agile environment in teams formed of engineers, content writers, testers and agile coaches',
      'Worked with JavaScript and libraries such as React, Moment, Redux, Lodash, Lottie etc.',
      'Led meetings such as sprint planning, retrospectives as well as demos to stakeholders while communicating clearly and effectively to teams and board members',
      'Worked on projects that had strict deadlines, ensuring all work met deadlines and were to a high standard',
