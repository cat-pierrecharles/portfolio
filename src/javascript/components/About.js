      ...
      <div className='row'>
        <div className='col-md-7'>
          ...
          <ul className='pt-4 fa-ul'>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>JavaScript</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>React</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>Express</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>NodeJS</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>HTML</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>CSS</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>Git</li>
            <li><span class='fa-li'><i class='fas fa-egg'></i></span>UNIX</li>
          </ul>
        </div>
