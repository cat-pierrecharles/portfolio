    ...
    <div className='my-4'>
      <div className='row'>
        ...
        <div className='col-sm-12 col-md-6 py-2'>
          <h1 className='h4 color-tertiary'>{params.name}</h1>
          <div className='my-3'>
            <a className='h4 mr-3' href={params.git} target='_blank'><i className='fab fa-github' /></a>
            <a className='h4 mr-3' href={params.web} target='_blank'><i className='fas fa-external-link-alt' /></a>
          </div>
